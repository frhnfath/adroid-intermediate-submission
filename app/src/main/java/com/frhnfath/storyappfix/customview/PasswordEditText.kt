...
class PasswordEditText : AppCompatEditText, View.OnTouchListener {
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        // insert hint on password edit text
    ...
    private fun init() {
        ...
        clearButtonImage = ContextCompat.getDrawable(context, R.drawable.ic_clear_black_24) as Drawable
        setOnTouchListener(this)

        // insert action on text change and shows clear button
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                if (s.toString().isNotEmpty() && s.toString().length < 6) error = resources.getString(
